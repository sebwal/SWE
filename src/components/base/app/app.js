...
(function (WebShop) {
    ...
    var SidebarController = (function () {
        function SidebarController() {
            this.elements.push(new WebShop.SidebarElement("Home"));
            this.elements.push(new WebShop.SidebarElement("Warenkorb"));
            this.elements.push(new WebShop.SidebarElement("Wunschliste"));
            this.elements.push(new WebShop.SidebarElement("Bestellungen"));
        }
        SidebarController.prototype.alertElements = function () {
            alert("test");
        };
...
(function (WebShop) {
    ...
    var SidebarElement = (function () {
        function SidebarElement(text) {
            this.text = text;
            this.active = false;
        }
        SidebarElement.prototype.setActive = function (active) {
            this.active = active;
        };
        return SidebarElement;
    })();
    WebShop.SidebarElement = SidebarElement;
})(WebShop || (WebShop = {}));
/// <reference path="../../_all.ts"/>
var App;
(function (App) {
